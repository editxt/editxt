...
rules[1] = _group1.rules[0]
rules[2] = ('comment', comment0)
rules[3] = _group1.rules[2]
rules[4] = _group1.rules[3]
rules[5] = ('symbol', symbol)
rules[6] = _group1.rules[5]
rules[7] = ('number', number)
rules[8] = ('literal', literal)
