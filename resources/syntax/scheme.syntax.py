...
rules = [
    ...
    None,  # _group5.rules[5],
    None,  # _group5.rules[6],
]

_group2.rules[1] = ('number', number3)
_group2.rules[2] = rules[6]
_group2.rules[3] = ('symbol', symbol)
_group5.rules[1] = ('number', number3)
_group5.rules[2] = rules[6]
_group5.rules[3] = ('symbol', symbol)
_group5.rules[4] = rules[9]
rules[10] = _group5.rules[5]
rules[11] = _group5.rules[6]
