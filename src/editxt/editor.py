...
class EditorWindowController(NSWindowController):
    ...
    docsController = objc.ivar("docsController")
    docsScrollview = objc.ivar("docsScrollview")
    docsView = objc.ivar("docsView")
    mainView = objc.ivar("mainView")
    splitView = objc.ivar("splitView")
    plusButton = objc.ivar("plusButton")
    propsView = objc.ivar("propsView")
    propsViewButton = objc.ivar("propsViewButton")
    #propCharacterEncoding = objc.ivar("propCharacterEncoding")
    #propLanguageSelector = objc.ivar("propLanguageSelector")
    #propLineEndingType = objc.ivar("propLineEndingType")
    #propTabSpacesInput = objc.ivar("propTabSpacesInput")
    #propTabSpacesSelector = objc.ivar("propTabSpacesSelector")
    #propWrapLines = objc.ivar("propWrapLines")
