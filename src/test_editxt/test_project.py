...
from test_editxt.util import TestConfig, check_app_state

log = logging.getLogger("test_editxt.test_project")
# log.debug("""TODO
#     Project.is_dirty - should be True after a document is dragged within the project
# """)

def test_document_view_interface():
    from test_editxt.test_document import verify_document_view_interface
    view = Project.create()
