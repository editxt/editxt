...
from test_editxt.util import do_method_pass_through, TestConfig

log = logging.getLogger("test_editxt.test_editor")
# log.debug("""TODO test
    ...
    def test(c):
        ...
        if c.view_is_current:
            ...
            if c.view_class is TextDocumentView:
                dv.scroll_view >> (sv if c.view_is_main else None)
