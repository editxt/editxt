...
#        "<drag result>"
    ...
    yield test, ("doMenuCommand_", "do_menu_command"), ("sender",), ("sender",)
    item = TestConfig(action=lambda:"doMenuCommand:")
    yield test, ("validateUserInterfaceItem_", "validate_menu_command"), (item,), (item,)
